...
import com.tistory.windingroad.repository.JournalRepository;

@SpringBootApplication
public class SimpleMongoAppApplication {
  /**
   * spring init -d=data-mongodb -g=com.tistory.windingroad -a=simple-mongo-app --package-name=com.tistory.windingroad -name=simple-mongo-app -x
   */
